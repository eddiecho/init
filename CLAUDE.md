...
- `make home HOME_CONFIG=<name>` — standalone home-manager switch for a `hosts/home/<system>/<name>` host (a machine with no NixOS/nix-darwin system config of its own). Not for `framework`/`window`/`work` — see `hosts/home/README.md`.
