...
hl.on("hyprland.start", function()
    -- Replaces wayland.windowManager.hyprland.systemd.enable's exec-once.
    hl.exec_cmd("dbus-update-activation-environment --systemd DISPLAY HYPRLAND_INSTANCE_SIGNATURE WAYLAND_DISPLAY XDG_CURRENT_DESKTOP SYSTEMD_EXEC_PID")
